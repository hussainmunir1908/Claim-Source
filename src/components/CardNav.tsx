...
const CardNav = ({
  ...
  const calculateHeight = () => {
    ...
    return 360; // default desktop expanded height
  };
  ...
  return (
    <div className={`card-nav-container ${className}`}>
      <nav ref={navRef} className={`card-nav ${isExpanded ? 'open' : ''}`} style={{ backgroundColor: baseColor }}>
        ...
        <div className="card-nav-content" aria-hidden={!isExpanded} style={{ visibility: isExpanded ? 'visible' : 'hidden', pointerEvents: isExpanded ? 'auto' : 'none' }}>
